...
<form class="layui-form" lay-filter="myform" action="../ClientType/insert">
</c:if>

<c:if test="${param.id!=null}">
<form class="layui-form" lay-filter="myform" action="../ClientType/update">
...
function init(){
	$.post("../ClientType/edit",{id:id}, function(json) {
		render('myform', json);
	},"json");
