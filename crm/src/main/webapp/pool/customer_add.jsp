...
.layui-input {
	...
	<div class="layui-form-item">
		...
		<div class="layui-inline">
			...
			<div class="layui-input-block">
				<input type="text" name="tel" autocomplete="off" placeholder="请输入电话"
					class="layui-input">
			</div>
		</div>
	</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-inline">
			...
			<div class="layui-input-block">
				<input type="text" name="qq" autocomplete="off" placeholder="请输入QQ"
					class="layui-input">
			</div>
		</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<textarea type="text" name="infos" autocomplete="off"
				placeholder="其他信息" class="layui-textarea"></textarea>
		</div>
	</div>
	<div class="layui-form-item">
	<div class="layui-inline">
	...
	<div class="layui-inline">
		...
		<div class="layui-input-block">
			<input type="text" name="count" autocomplete="off" placeholder="回访次数"
				class="layui-input">
		</div>
	</div>
	<div class="layui-form-item">
		...
		function init() {
			$.post("../Client/edit", {
				...
				getarray("../Client/getClientsname", "[name=clientstatus]",
						json.clientstatus);
				getarray("../Client/getPurposename", "[name=purposestatus]",
						json.purposestatus);
