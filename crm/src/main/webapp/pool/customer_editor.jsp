								...
								<div class="layui-inline">
									...
									<div class="layui-input-block">
										<input type="text" name="count" autocomplete="off"
											placeholder="回访次数" class="layui-input">
									</div>
								</div>
								<div class="layui-form-item">
												...
												.post(
														...
														function(json) {
															...
															getarray(
																	...
																	json.linkstatus);
															getarray(
																	"../Client/getClientsname",
																	"[name=clientstatus]",
																	json.clientstatus);
															getarray(
																	"../Client/getPurposename",
																	"[name=purposestatus]",
																	json.purposestatus);
															getarray(
																	"../Client/getAssessname",
																	"[name=assessstatus]",
																	json.assessstatus);
															getarray(
																	"../Client/getExecname",
