...
<script src="../lib/jquery-3.4.1/jquery-3.4.1.min.js"></script> <script
	type="text/javascript" src="../js/my.js"></script> <script
	type="text/javascript" src="../js/table.js"></script>
...
.layui-input {
	...
	<div class="layui-form-item">
		...
		<div class="layui-inline">
			...
			<div class="layui-input-block">
				<input type="text" name="tel" readonly="readonly" autocomplete="off"
	...
	<div class="layui-form-item">
		<div class="layui-inline">
			...
			<div class="layui-input-block">
				<input type="text" name="qq" readonly="readonly" autocomplete="off"
		...
		<div class="layui-inline">
			...
			<div class="layui-input-block">
				<input type="text" name="email" readonly="readonly"
					autocomplete="off" placeholder="请输入email" class="layui-input">
			</div>
		</div>
	</div>
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<textarea type="text" name="infos" readonly="readonly"
				autocomplete="off" placeholder="其他信息" class="layui-textarea"></textarea>
		</div>
	</div>
	<div class="layui-form-item">
		<div class="layui-inline">
	...
	<div class="layui-form-item">
		...
		<div class="layui-form-item">
			...
			<div class="layui-inline">
				...
				<div class="layui-input-block">
					<input type="hidden" name="operatorids"> <input type="text"
						name="operatornames" readonly="readonly" autocomplete="off"
						placeholder="请输入" class="layui-input" id="demo">
				</div>
			</div>
			<div class="layui-inline">
		...
		<div class="layui-form-item">
			<div class="layui-inline">
				...
				<div class="layui-input-block">
					<input type="text" name="createdate" readonly="readonly"
			...
			<div class="layui-inline">
				...
				<div class="layui-input-block">
					<input type="text" name="count" readonly="readonly"
						autocomplete="off" placeholder="回访次数" class="layui-input">
				</div>
			</div>
		</div>
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<textarea type="text" name="comments" readonly="readonly"
					autocomplete="off" placeholder="备注" class="layui-textarea"></textarea>
			</div>
		</div>
		...
		<script type="text/javascript"
			src="../js/lay-module/tableSelect/tableSelect.js"></script>
		<script type="text/javascript">
			...
			function init() {
				$.post("../Client/edit", {
					...
					getarray("../Client/getStatusname", "[name=status]",
							json.status);
					getarray("../Client/getLinkname", "[name=linkstatus]",
							json.linkstatus);
					getarray("../Client/getClientsname", "[name=clientstatus]",
							json.clientstatus);
					getarray("../Client/getPurposename",
							"[name=purposestatus]", json.purposestatus);
					getarray("../Client/getAssessname", "[name=assessstatus]",
							json.assessstatus);
					getarray("../Client/getExecname", "[name=execstatus]",
							json.execstatus);
					getlist("../Client/getTypes", "[name=clienttypeid]",
							json.clienttypeid);
					getlist("../Client/getOperator", "[name=createoperatorid]",
							json.createoperatorid);
